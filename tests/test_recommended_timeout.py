...
class RecommendedTimeoutTests(unittest.TestCase):
    def test_context_size_maps_to_timeout(self):
        self.assertEqual(300000, ciel_runtime.recommended_timeout_ms_for_context(None))
        self.assertEqual(300000, ciel_runtime.recommended_timeout_ms_for_context(1048576))
        self.assertEqual(180000, ciel_runtime.recommended_timeout_ms_for_context(524288))
        self.assertEqual(120000, ciel_runtime.recommended_timeout_ms_for_context(262144))
        self.assertEqual(120000, ciel_runtime.recommended_timeout_ms_for_context(65536))
    ...
    def test_ollama_cloud_large_model_applies_weighted_timeout(self):
        ...
        with mock.patch.object(ciel_runtime, "ollama_catalog_timeout_for_model", return_value=None):
            messages = ciel_runtime.apply_recommended_timeout_for_model_context("ollama-cloud", pcfg)
    ...
    def test_half_million_context_applies_five_minute_timeout(self):
        ...
        ciel_runtime.apply_recommended_timeout_for_model_context("vllm", pcfg)
    ...
    def test_quarter_million_ollama_cloud_context_applies_weighted_timeout(self):
        ...
        with mock.patch.object(ciel_runtime, "ollama_catalog_timeout_for_model", return_value=None):
            ciel_runtime.apply_recommended_timeout_for_model_context("ollama-cloud", pcfg)
    ...
    def test_unknown_model_change_falls_back_to_five_minutes(self):
        ...
        ciel_runtime.apply_recommended_timeout_for_model_context("ollama-cloud", pcfg, use_context_fallback=False)
    ...
    def test_explicit_context_change_still_uses_context_recommendation(self):
        ...
        with mock.patch.object(ciel_runtime, "ollama_catalog_timeout_for_model", return_value=None):
            ciel_runtime.apply_recommended_timeout_for_model_context("ollama-cloud", pcfg, use_context_fallback=True)
    ...
    def test_active_128k_preset_is_not_lowered_by_ollama_catalog_timeout(self):
        ...
        with mock.patch.object(ciel_runtime, "ollama_catalog_timeout_for_model", return_value=120000):
            ciel_runtime.apply_recommended_timeout_for_model_context("ollama-cloud", pcfg, use_context_fallback=False)
    ...
    def test_ollama_catalog_timeout_is_not_used_for_non_ollama_providers(self):
        ...
        with mock.patch.object(ciel_runtime, "ollama_catalog_timeout_for_model", return_value=120000) as catalog_timeout:
            ciel_runtime.apply_recommended_timeout_for_model_context("opencode", pcfg, use_context_fallback=False)
    ...
    def test_llm_preset_application_sets_slow_128k_timeout(self):
        ...
        with mock.patch.object(ciel_runtime, "sync_ollama_library_context_limit", return_value=[]), mock.patch.object(
            ciel_runtime, "ollama_catalog_timeout_for_model", return_value=120000
        ):
            ciel_runtime.apply_llm_preset_to_provider("ollama-cloud", pcfg, "long-context-128k", "en")
    ...
    def test_hosted_output_and_context_are_combined(self):
        ...
        ciel_runtime.apply_recommended_timeout_for_model_context("opencode", pcfg, use_context_fallback=True)
